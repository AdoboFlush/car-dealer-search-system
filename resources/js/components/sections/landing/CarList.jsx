...
export default function CarListing() {
    ...
    const fetchData = (page, search) => {
        ...
        setIsLoading(true)
        fetchGuestCars({ page: page, perPage: carsPerPage, search: search })
            .then((response) => {
    ...
    return (
        <div className="container mx-auto px-4 py-8 mt-20">
            ...
            <header className="mb-12 text-center">
                <h1 className="text-4xl font-bold mb-2">Secondhand car finder in the Philippines</h1>
                <p className="text-muted-foreground">Find your perfect car</p>
            </header>
